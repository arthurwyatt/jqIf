    ...
    $.fn.jqIf = function(options) {
        ...
        var Tree = function (elem, options) {
                ...
                if (elem.length === 1) {
                    ...
                    throw "Selector for jqIf returns no elements";
                } else {
                    throw "Selector for jqIf returns too many elements"
                }
            };
        ...
        Tree.prototype.init = function () {
            ...
            //set up UI        
            this.elem.on("click", "button", $.proxy(
                function(e) { 
